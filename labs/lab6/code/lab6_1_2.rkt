...
; Question 1
(display (make-string 3 #\*)) (display "6.1") (display (make-string 3 #\*)) (newline) (newline) ; make-string n p, де n (number) - число, p (pattern) - символ.
(display "Enter the length of vector: ") (insert_value_vector (read)) (newline)


; Question 2
(display (make-string 3 #\*)) (display "6.2") (display (make-string 3 #\*)) (newline) (newline) ; make-string n p, де n (number) - число, p (pattern) - символ.
